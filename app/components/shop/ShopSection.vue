  ...
  <div class="shop-section">
    ...
    <div class="shop-category">
      ...
      <div class="items-grid">
        <div class="shop-item" v-for="chest in chests" :key="chest.id">
...
<script setup>
// Используем composable для управления данными магазина
const { chests, bonusInvestments, planets, buyItem } = useShopData();
